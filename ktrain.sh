...
#time python ktrain.py wideparam_oldtf
time python learningcurve.py graphs-wideparam_oldtf
time python validatescale.py graphs-wideparam_oldtf
time python validatedose.py graphs-wideparam_oldtf
